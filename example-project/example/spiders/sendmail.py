...
def send_dailyreport():
    ...
    smtp_server = 'smtp.mxhichina.com'
    smtp_port = 25
    #to_addr_str = 'alexhu@wezhuiyi.com;monitor@wezhuiyi.com;milowang@wezhuiyi.com'
    to_addr_str = 'alexhu@wezhuiyi.com;milowang@wezhuiyi.com;jonnyxu@wezhuiyi.com'

    msg = MIMEMultipart('related')
    msg['From'] = from_addr
    msg['To'] = to_addr_str
    subject = '[2016-06-09]滴滴客服运营日报'
